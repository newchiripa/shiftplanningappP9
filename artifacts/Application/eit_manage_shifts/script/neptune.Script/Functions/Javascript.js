...
function calculateWeeklyHours(givenDate) {
    const activities = modelModelArray.getData();
    ...
    mondayOfThisWeek.setHours(0, 0, 0, 0); // Pazartesi gününü günün başlangıcına ayarla

    // Calculate the Sunday date of this week
    const sundayOfThisWeek = new Date(mondayOfThisWeek);
    sundayOfThisWeek.setDate(mondayOfThisWeek.getDate() + 6);
    sundayOfThisWeek.setHours(23, 59, 59, 999); // Pazar gününü günün sonuna ayarla
