...
weekDays.forEach((day, index) => {
    ...
    console.log(
        day + " (" + dayOfThisWeek.toLocaleDateString() + ") total working time:",
        totalWorkHours,
        "hours",
        totalWorkMinutes,
        "minutes"
...
console.log(
    ...
    totalWeekWorkHours,
    "hours",
    totalWeekWorkMinutes,
    "minutes"
);
TitleTotalWorkedHours.setText(
    "Total working time this week:" +
        " " +
        totalWeekWorkHours +
        " " +
...
// debugger
var limit = parseInt(TextWorkingLimit.getText());
var remainingTime = limit - totalWeekWorkHours;
...
var options = {
    ...
    data: {
        worked_hours_weekly: remainingTime,
    },
};

apiRestAPIEmployeeUpdate(options);
